...
Интерфейс приложения позволяет пользователю выбрать один из алгоритмов, а также увеличивать и уменьшать масштаб сетки, используя клавиши на клавиатуре:
...
+ — Увеличение масштаба
- — Уменьшение масштаба
При этом все элементы интерфейса обновляются динамически, что облегчает процесс работы с отрезками и кривыми.
